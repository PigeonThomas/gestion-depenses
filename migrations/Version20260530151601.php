 ...
 */
final class Version20260530151601 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE UNIQUE INDEX UNIQ_54AF5F279BBEBB6A ON magasin (lien_magasin)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX UNIQ_54AF5F279BBEBB6A ON magasin');
    }
}
